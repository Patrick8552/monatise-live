...
description: Run the production Monatise cryptocurrency analysis workflow and return GRID, TREND, or NO_TRADE. Use for direct crypto analysis requests after routing and collection; never use OpenClaw itself as an execution engine.
---
