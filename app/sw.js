const CACHE_NAME = "monatise-shell-20260727-feedback-email-v2";
const SHELL_ASSETS = [
  "./",
  "./cg.html",
  "./dashboard/",
  "./game.html",
  "./memecoins.html",
  "./coinglass-dashboard.html?v=20260727-feedback-email-v2",
  ...
  "./coinglass-dashboard.js?v=20260727-feedback-email-v2",
