const CACHE_NAME = "monatise-shell-20260805-consistent-grid-v1";
const SHELL_ASSETS = [
  "./",
  "./cg.html",
  "./dashboard/",
  "./game.html",
  "./memecoins.html",
  "./coinglass-dashboard.html?v=20260805-consistent-grid-v1",
  ...
  "./coinglass-dashboard.js?v=20260805-consistent-grid-v1",
