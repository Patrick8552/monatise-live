const CACHE_NAME = "monatise-shell-20260811-dashboard-reliability-v3";
const SHELL_ASSETS = [
  "./",
  "./cg.html",
  "./dashboard/",
  "./game.html",
  "./memecoins.html",
  "./coinglass-dashboard.html?v=20260811-dashboard-reliability-v3",
  ...
  "./coinglass-dashboard.css?v=20260811-dashboard-reliability-v3",
