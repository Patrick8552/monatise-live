const CACHE_NAME = "monatise-shell-20260727-dashboard-first-v7";
const SHELL_ASSETS = [
  "./",
  "./cg.html",
  "./dashboard/",
  "./game.html",
  "./memecoins.html",
  "./coinglass-dashboard.html?v=20260727-minimal-dashboard-v3",
  "./styles.css?v=20260727-dashboard-first-v7",
  "./app.js?v=20260727-dashboard-first-v7",
  "./spotify.js?v=20260629-request-access-fix",
  "./game.js?v=20260629-crypto-trainer",
  "./assets/payout-clients.svg",
  "./coinglass-dashboard.css?v=20260727-minimal-dashboard-v3",
  "./coinglass-dashboard.js?v=20260727-minimal-dashboard-v3",
