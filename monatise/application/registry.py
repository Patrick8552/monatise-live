...
PRODUCTION_ENGINE_ORDER = (
    "market_data", "regime", "liquidity", "liquidity_sweep",
    "supply_demand", "reclaim", "market_structure", "fibonacci_liquidity",
    "order_flow", "decision", "rsi", "portfolio_intelligence",
...
def canonical_registrations(engine_order: tuple[str, ...] = CANONICAL_ENGINE_ORDER) -> tuple[EngineRegistration, ...]:
    ...
    engine_methods = dict(zip(CANONICAL_ENGINE_ORDER, ("collect", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "assess", "build", "assess", "build", "assess")))
